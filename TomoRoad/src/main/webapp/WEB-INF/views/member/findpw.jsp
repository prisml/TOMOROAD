...
<body>
<div >	
	<form name="formFindid" method="post" action="${pageContext.request.contextPath}/findPw.do" onSubmit="return idSearch()" >
	                <br>
                <br>
                <br>
	<fieldset>
	...
	<li><input type="submit" name="btnFindUid" id="btnFindUid" value="Find Password" ></li>
