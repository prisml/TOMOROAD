package org.kosta.tomoroad.model.pagingbean;
	...
	public class PagingBean {
		...
		public int getStartRowNumber() {
			return nowPage * contentNumberPerPage - (contentNumberPerPage - 1);
		}
		...
		public int getEndRowNumber() {
			if (totalContents < nowPage * contentNumberPerPage) {
				return totalContents;
			}
			return nowPage * contentNumberPerPage;
		}
		...
		public int getStartPageOfPageGroup() {
			int num = 0;
			num = this.getNowPageGroup() * this.pageNumberPerPageGroup - (this.pageNumberPerPageGroup - 1);
			return num;
		}
		...
		public int getEndPageOfPageGroup() {
			int num = 0;
			if (this.getTotalPage() < this.getNowPageGroup() * this.pageNumberPerPageGroup) {
				num = getTotalPage();
			} else {
				num = this.getNowPageGroup() * this.pageNumberPerPageGroup;
			}
			return num;
		}
